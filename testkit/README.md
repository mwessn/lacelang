...
|------------------------------|--------------------------------|-------------|-------|
| `vectors/01_parsing/`        | Parsing                        | `parse`     | 28<!-- vc:01_parsing -->    |
...
| `vectors/10_failure_cascade/`| Failure cascade                | `execute`   | 5<!-- vc:10_failure_cascade -->    |
...
|--------------------|-------|-------------|
| laceNotifications  | 16<!-- vc:ext.laceNotifications -->     | `extension` |
...
Markdown documentation uses `0.9.7<!-- sv -->` and `{{ vectorCount[:key] }}`
